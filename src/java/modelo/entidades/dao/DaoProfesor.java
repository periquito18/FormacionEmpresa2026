...
public class DaoProfesor {
    ...
    // ---- CREATE ----
    /**
     * Inserta un nuevo profesor en la base de datos Verifica antes que no
     * exista otro profesor con el mismo email
     *
    ...
    /**
     * Busca un profesor por su email Útil para validar duplicados y para el
     * login
     *
    ...
    /**
     * Devuelve todos los profesores de la bd Usado por la Directiva para
